...
if (typeof window === 'undefined' || process.env.APP_ENV === 'testing') {
	...
	const development = {
		...
		ALGOLIA_QUERY_SUGGESTIONS_INDEX_IDEA: indexes.idea.suggestions,
		ALGOLIA_INDEX_SERVICE: indexes.service.default,
		ALGOLIA_QUERY_SUGGESTIONS_INDEX_SERVICE: indexes.service.suggestions,
